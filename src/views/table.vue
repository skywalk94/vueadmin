<template>
  <div class="box">
    <download-excel :fields="fields" :data="tableData" name="用户数据" type="xls">
      <el-button type="primary" icon="el-icon-download">导出表格</el-button>
    </download-excel>
    <el-table :data="
        tableData.slice((currentPage - 1) * pagesize, currentPage * pagesize)
      " border style="width: 100%" stripe highlight-current-row row-key="id" @selection-change="selectTable">
  ...
  export default {
    ...
    data() {
      return {
        ...
        imgUrl: "https://sucai.suoluomei.cn/sucai_zs/images/20200711135449-b3a2a02b62999fa7ebcebcd9fad537d.jpg",
      };
    },
    mounted() {
      this.moreData();
