<template>
  <div class="box">
    <img :class="['main', isSpin ? 'start' : 'reset']" :style="{ transform: isSpin ? `rotate(-${rotate}deg)` : 'none' }"
      src="https://sucai.suoluomei.cn/sucai_zs/images/20190926090636-1.png" alt="" />
    <div class="point" @click="startDraw()">
      <img src="https://sucai.suoluomei.cn/sucai_zs/images/20190924162756-kaishiaa.png" alt="" />
    </div>
  </div>
</template>
